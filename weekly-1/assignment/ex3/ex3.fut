...
entry test_reduce (xs: []i32) : i32 =
  reduce (+) 0 xs

entry test_segscan (xs: []i32) (flags: []bool) : []i32 =
  segscan (+) 0 (zip xs flags)

entry test_segreduce (xs: []i32) (flags: []bool) : []i32 =
...
entry test_reduce_by_index_builtin [n] (xs: [n]i32) (idxs: [n]i8) : [n]i32 =
  ...
  in reduce_by_index dest (+) 0 (map i64.i8 idxs) xs
